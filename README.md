...
The function is built on top of [ax.annotate](https://matplotlib.org/stable/api/_as_gen/matplotlib.axes.Axes.annotate.html)  and takes the same **kwargs. The difference is that differently from ax.annotate takes as arguments 3 iterables x, y, and the list of labels instead of the single desired annotation and coordinates.
...
```
![Alt text](overlab/images/no_overlab.png?raw=true "No_overlab")
...
![Alt text](overlab/images/overlab.png?raw=true "No_overlab")
